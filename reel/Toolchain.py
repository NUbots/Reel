...
class Toolchain:
    ...
    def __init__(self, name):
        ...
        self.prefix_dir = 'toolchain'
        self.working_dir = os.path.join('toolchain', 'toolchain_build')
        self.archive_dir = os.path.join(self.working_dir, 'archive')
        self.sources_dir = os.path.join(self.working_dir, 'src')
        ...
        self.add_library(name='gcc', url='https://ftpmirror.gnu.org/gnu/gcc/gcc-7.1.0/gcc-7.1.0.tar.bz2')
        self.add_library(name='musl', url='https://www.musl-libc.org/releases/musl-1.1.16.tar.gz')
        self.add_library(name='binutils', url='https://ftpmirror.gnu.org/gnu/binutils/binutils-2.28.tar.bz2')
        self.add_library(name='libbacktrace', url='https://github.com/ianlancetaylor/libbacktrace/archive/master.tar.gz')

    def add_library(self, name, *args, **kwargs):
        self.libraries.append(Library(name, self, SmartDownload, SmartExtract, SmartBuild, *args, **kwargs))
